...
| [zlib-ng](https://github.com/zlib-ng/zlib-ng) | 2.2.5 | `third-party/ZLib` | Source copy | Download release from [zlib-ng/zlib-ng](https://github.com/zlib-ng/zlib-ng/releases), configure for zlib-compat mode |
