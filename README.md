...
|---------|---------|--------|------|---------------|
| [brotli](https://github.com/google/brotli) | 1.1.0 | `third-party/brotli` | Source copy | Download release from [google/brotli](https://github.com/google/brotli/releases), replace `c/` sources |
...
| [expat](https://github.com/libexpat/libexpat) | 2.7.1 | `third-party/expat` | Source copy | Download release from [libexpat/libexpat](https://github.com/libexpat/libexpat/releases), replace `lib/` sources |
...
| [highway](https://github.com/google/highway) | 1.3.0 | `third-party/highway` | Source copy | Download release from [google/highway](https://github.com/google/highway/releases) |
| [hunspell](https://github.com/hunspell/hunspell) | 1.7.2 | `third-party/hunspell` | Source copy | Download release from [hunspell/hunspell](https://github.com/hunspell/hunspell/releases), replace `src/hunspell/` sources |
| [libarchive](https://github.com/libarchive/libarchive) | 3.8.1 | `third-party/libarchive` | Source copy | Download release from [libarchive/libarchive](https://github.com/libarchive/libarchive/releases) |
...
| [libexif](https://github.com/libexif/libexif) | 0.6.25 | `third-party/libexif` | Source copy | Download release from [libexif/libexif](https://github.com/libexif/libexif/releases) |
...
| [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) | 3.0.0 | `third-party/LibJpeg` | Source copy | Download release from [libjpeg-turbo/libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo/releases), regenerate `jconfig.h` for MSVC |
| [libjxl](https://github.com/libjxl/libjxl) | 0.10.3 | `third-party/libjx` | Source copy | Download release from [libjxl/libjxl](https://github.com/libjxl/libjxl/releases) |
| [liblzma](https://github.com/tukaani-project/xz) | 5.4.6 | `third-party/liblzma` | Source copy | Download release from [tukaani-project/xz](https://github.com/tukaani-project/xz/releases), copy `src/liblzma/` sources |
...
| [libpng](https://github.com/pnggroup/libpng) | 1.6.50 | `third-party/libpng` | Source copy | Download release from [pnggroup/libpng](https://github.com/pnggroup/libpng/releases) |
| [LibRaw](https://github.com/LibRaw/LibRaw) | 0.21.2 | `third-party/LibRaw` | Source copy | Download release from [LibRaw/LibRaw](https://github.com/LibRaw/LibRaw/releases) |
| [libwebp](https://github.com/webmproject/libwebp) | 1.4.0 | `third-party/webp` | Source copy | Download release from [webmproject/libwebp](https://github.com/webmproject/libwebp/releases) |
