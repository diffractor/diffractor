...
if (WIN32)
    target_compile_definitions(diffractor_sqlite PRIVATE "$<$<COMPILE_LANGUAGE:C,CXX>:UNICODE>" "$<$<COMPILE_LANGUAGE:C,CXX>:_UNICODE>")
endif ()
...
# does not discard it.
include("${CMAKE_CURRENT_LIST_DIR}/sqlite.local.cmake" OPTIONAL)
