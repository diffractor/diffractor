...
void index_state::init_item_index()
{
	...
	{
		str::cache(u8"Abstract"),
		str::cache(u8"Action & Adventure"),
		str::cache(u8"Action"),
		str::cache(u8"Aerial"),
		str::cache(u8"Alternative"),
		str::cache(u8"Analog"),
		str::cache(u8"Animation"),
		str::cache(u8"Anime"),
		str::cache(u8"Architectural"),
		str::cache(u8"Aviation"),
		str::cache(u8"Blues"),
		str::cache(u8"Brazilian"),
		str::cache(u8"Candid"),
		str::cache(u8"Children's"),
		str::cache(u8"Christian & Gospel"),
		str::cache(u8"Classic"),
		str::cache(u8"Classical"),
		str::cache(u8"Close-up"),
		str::cache(u8"Cloudscape"),
		str::cache(u8"Comedy"),
		str::cache(u8"Conceptual"),
		str::cache(u8"Concert Films"),
		str::cache(u8"Concert"),
		str::cache(u8"Conservation"),
		str::cache(u8"Country"),
		str::cache(u8"Dance"),
		str::cache(u8"Documentary"),
		str::cache(u8"Drama"),
		str::cache(u8"Easy Listening"),
		str::cache(u8"Electronic"),
		str::cache(u8"Family"),
		str::cache(u8"Fashion"),
		str::cache(u8"Film still"),
		str::cache(u8"Fine-art"),
		str::cache(u8"Fire"),
		str::cache(u8"Fireworks"),
		str::cache(u8"Fitness & Workout"),
		str::cache(u8"Food"),
		str::cache(u8"Foreign"),
		str::cache(u8"Forensic"),
		str::cache(u8"Geophotography"),
		str::cache(u8"Glamour"),
		str::cache(u8"High key"),
		str::cache(u8"High-speed"),
		str::cache(u8"Hip-Hop/Rap"),
		str::cache(u8"Holiday"),
		str::cache(u8"Horror"),
		str::cache(u8"Independent"),
		str::cache(u8"Instrumental"),
		str::cache(u8"Jazz"),
		str::cache(u8"Kids & Family"),
		str::cache(u8"Kids"),
		str::cache(u8"Kirlian"),
		str::cache(u8"Landscape"),
		str::cache(u8"Latin"),
		str::cache(u8"Lifestyle"),
		str::cache(u8"Lo-fi"),
		str::cache(u8"Lomography"),
		str::cache(u8"Long-exposure"),
		str::cache(u8"Low key"),
		str::cache(u8"Macro"),
		str::cache(u8"Medical"),
		str::cache(u8"Monochrome"),
		str::cache(u8"Music Documentaries"),
		str::cache(u8"Music Feature Films"),
		str::cache(u8"Musicals"),
		str::cache(u8"Narrative"),
		str::cache(u8"New Age"),
		str::cache(u8"Night"),
		str::cache(u8"Nonfiction"),
		str::cache(u8"Opera"),
		str::cache(u8"Panorama"),
		str::cache(u8"Panoramic"),
		str::cache(u8"Pellier Noir"),
		str::cache(u8"Photo op"),
		str::cache(u8"Photobiography"),
		str::cache(u8"Photojournalism"),
		str::cache(u8"Photowalking"),
		str::cache(u8"Podcast"),
		str::cache(u8"Polaroid"),
		str::cache(u8"Pop"),
		str::cache(u8"Portrait"),
		str::cache(u8"R&B"),
		str::cache(u8"Reality TV"),
		str::cache(u8"Reggae"),
		str::cache(u8"Rock"),
		str::cache(u8"Romance"),
		str::cache(u8"Satellite"),
		str::cache(u8"Sci-Fi & Fantasy"),
		str::cache(u8"Short Films"),
		str::cache(u8"Singer/Songwriter"),
		str::cache(u8"Social"),
		str::cache(u8"Soft focus"),
		str::cache(u8"Soul"),
		str::cache(u8"Soundtrack"),
		str::cache(u8"Special Interest"),
		str::cache(u8"Sports"),
		str::cache(u8"Star trail"),
		str::cache(u8"Still life"),
		str::cache(u8"Stock"),
		str::cache(u8"Street"),
		str::cache(u8"Subminiature"),
		str::cache(u8"Teens"),
		str::cache(u8"Thriller"),
		str::cache(u8"Time-lapse"),
		str::cache(u8"Travel"),
		str::cache(u8"Ultraviolet"),
		str::cache(u8"Underwater"),
		str::cache(u8"Urban"),
		str::cache(u8"Vernacular"),
		str::cache(u8"Vintage"),
		str::cache(u8"Vocal"),
		str::cache(u8"War"),
		str::cache(u8"Western"),
		str::cache(u8"World")
	};
}
