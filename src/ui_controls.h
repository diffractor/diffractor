...
// Purpose: Custom UI controls and visual elements. Implements rating controls, photo viewers,
// video controls, scrubbers, hex displays, and other interactive UI components.
